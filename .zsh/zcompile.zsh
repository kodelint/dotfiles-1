...
#
# [[ $HOME/.zshenv -nt $HOME/.zshenv.zwc ]] && zrecompile -p $HOME/.zshenv && . $HOME/.zshenv
# [[ $HOME/.zshrc -nt $HOME/.zshrc.zwc ]] && zrecompile -p $HOME/.zshrc && . $HOME/.zshrc
# [[ $HOME/.zprofile -nt $HOME/.zprofile.zwc ]] && zrecompile -p $HOME/.zprofile && . $HOME/.zprofile


# if [[ -n "$HOME/*.zwc.old" ]]; then
# setopt nonomatch
